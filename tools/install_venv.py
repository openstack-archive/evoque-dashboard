# Copyright 2015 99Cloud Information Technologies Co., Ltd.
#
...
def install_evoque_dashboard():
    print 'Installing Evoque Dashboard module in development mode...'
    run_command([WITH_VENV, 'python', 'setup.py', 'develop'], cwd=ROOT)


def print_summary():
    summary = """
Evoque Dashboard development environment setup is complete.
